...
const DESCRIPTIONS = {
  ...
  "authentication": "Test authenticated MCP servers with MCP Rigor: static bearer tokens, API-key and custom headers, OAuth and short-lived tokens, the ${env.NAME} placeholder, project environments, and CI secrets — with automatic redaction.",
